...
export const GUIDE_STEPS: GuideStep[] = [
  {
    ...
    body: "Пульсирующие кольца отмечают районы. Красное — показатель упал ниже критической черты 40: в Нуре это школы (38) и медпомощь (35). Каждый такой провал отнимает балл от итогового Score. Оранжевое — слабые места без провала, молния — ЧС. Нажмите на метку: откроется карточка с деталями и кнопкой «Смотреть в 3D».",
    before: toMap,
  },
  {
    target: "events",
  ...
  },
  {
    ...
    body: "«Аким» — последствия скрыты до подписи бюджета, как в жизни. «Аналитик» — живой прогноз Score под бюджетом, прирост «+X к Score» на каждой карточке и кольца на карте, которые меняют цвет по прогнозу.",
  },
  {
    target: "catalog",
    icon: "school",
