...
- **«Аким» и «Аналитик».** В режиме «Аким» (по умолчанию) результат скрыт до подписи, как у настоящего акима. «Аналитик» показывает величины эффектов и живой прогноз Score.
