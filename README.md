...
![Итог сценария из кейса: Score 56,54, AI-анализ, районы на 3D-карте](docs/media/result-case-example.png)
...
npm ci
npm test            # 29 тестов движка: критерии кейса A1–A5, эталоны, правила, полный перебор
...
5. **Подпишите бюджет.** Появятся здания мер на карте и итог:
   - Score и прирост;
   - доля реализованного потенциала и место среди всех допустимых планов;
   - критические показатели;
   - районы до и после;
   - точный вклад каждой меры;
   - AI-анализ.
6. **Улучшите план.** Блок «Как улучшить» предлагает проверенные движком замены с приростом Score. «Призрак оптимума» показывает на карте лучший из 694 395 планов.
7. **Бриф для презентации** собирает одностраничное решение команды для печати или PDF.
...
| Сильные стороны, риски, последствия | Разделы отчёта: сильные стороны, риски, последствия для жителей, компромиссы, рекомендации |
